import { z } from 'zod';
import { ToolImplementation, ToolResponse, PatternSuggestion } from '../types.js';
...
// Pattern database
const patterns: Record<string, PatternSuggestion> = {
  'http-retry': {
...
function adaptPatternForFramework(pattern: PatternSuggestion, framework: string): PatternSuggestion {
